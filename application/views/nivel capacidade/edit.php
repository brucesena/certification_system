<form class="form-horizontal" method="post" action="<?=base_url('index.php/Nivel_capacidade/save');?>" >
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="nome" name="nome" type="text" placeholder="Nome do Nivel de Cpacidade" class="form-control input-md" required="" 
    value="<?=$dados['nome'];?>">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="sigla" name="sigla" type="text" placeholder="Digite a sigla do Nivel de Capacidade" class="form-control input-md"
   value="<?=$dados['sigla'];?>">
